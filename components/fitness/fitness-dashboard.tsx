    ...
    <div className="space-y-6">
      ...
      <div className="bg-card rounded-lg shadow p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-blue-50 dark:bg-blue-950/30 rounded-lg p-4">
            <p className="text-sm text-muted-foreground mb-1">Weekly Minutes</p>
            <p className="text-3xl font-bold text-blue-600 dark:text-blue-400">{stats.weeklyMinutes}</p>
            <p className="text-xs text-muted-foreground mt-1">Last 7 days</p>
          </div>
          <div className="bg-green-50 dark:bg-green-950/30 rounded-lg p-4">
            <p className="text-sm text-muted-foreground mb-1">Monthly Minutes</p>
          ...
          <div className="bg-purple-50 dark:bg-purple-950/30 rounded-lg p-4">
            ...
            <p className="text-3xl font-bold text-purple-600 dark:text-purple-400">{stats.totalExercises}</p>
      ...
      <div className="bg-card rounded-lg shadow p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <p className="text-sm text-muted-foreground mb-2">Total Exercise Time</p>
            <p className="text-2xl font-semibold">{stats.totalMinutes} minutes</p>
          </div>
          <div>
            <p className="text-sm text-muted-foreground mb-2">Total Calories Burned</p>
            <p className="text-2xl font-semibold">{stats.totalCalories} cal</p>
          </div>
          <div>
            <p className="text-sm text-muted-foreground mb-2">Average Intensity</p>
            <p className="text-2xl font-semibold">{stats.averageIntensity ?? '—'}</p>
          </div>
          <div>
            <p className="text-sm text-muted-foreground mb-2">Most Common Activity</p>
